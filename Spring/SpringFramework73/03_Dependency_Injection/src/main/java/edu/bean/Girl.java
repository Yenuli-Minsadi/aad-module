...
@Component
public class Girl implements Agreement, BeanNameAware, BeanFactoryAware, ApplicationContextAware, DisposableBean, InitializingBean {

    public Girl() {
        System.out.println("Girl obj created");
    }
    @Override
    public void chat(){
